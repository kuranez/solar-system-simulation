...
**Completed in v.1.7**
- ✅ **Major asteroids (Ceres, Vesta)** with realistic properties
- ✅ **Zoom and scaling improvements**

**Planned Features**
- Major asteroids (Pallas, Juno) with realistic properties
