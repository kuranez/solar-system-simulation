...
TNO_ERIS = {
    ...
    "radius": 1163e3,
    "mass": 1.66e22,
    "semi_major_axis": 67.67 * AU,
    "orbital_velocity": 3500,
    "color": (210, 210, 210)
}
...
TNO_HAUMEA = {
    ...
    "radius": 816e3,
    "mass": 4.006e21,
    "semi_major_axis": 43.13 * AU,
    "orbital_velocity": 3000,
    "color": (220, 220, 220)
}
...
TNO_MAKEMAKE = {
    ...
    "radius": 715e3,
    "mass": 3.1e21,
    "semi_major_axis": 45.79 * AU,
    "orbital_velocity": 2800,
    "color": (230, 230, 230)
}
...
TNO_QUAOAR = {
    ...
    "radius": 555e3,
    "mass": 1.4e21,
    "semi_major_axis": 43.42 * AU,
    "orbital_velocity": 2500,
    "color": (240, 240, 240)
}
...
TNO_SEDNA = {
    ...
    "radius": 500e3,
    "mass": 1.0e21,
    "semi_major_axis": 86.1 * AU,
    "orbital_velocity": 2000,
    "color": (250, 250, 250) 
}       
...
TNO_ORCUS = {
    ...
    "radius": 450e3,
    "mass": 6.32e20,
    "semi_major_axis": 39.4 * AU,
    "orbital_velocity": 2200,
    "color": (255, 255, 255)
}
...
TNO_GONGGONG = {
    ...
    "radius": 600e3,
    "mass": 1.75e21,
    "semi_major_axis": 67.8 * AU,
    "orbital_velocity": 1800,
    "color": (245, 245, 245)
}